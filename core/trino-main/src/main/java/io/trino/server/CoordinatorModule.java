...
import io.trino.cte.CteMaterializationStats;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        // CTE materialization orchestrator (runs internal scratch CTAS / DROP) + orphan-scratch sweeper + JMX stats
        ...
        binder.bind(CteMaterializationStats.class).in(Scopes.SINGLETON);
        newExporter(binder).export(CteMaterializationStats.class).withGeneratedName();
