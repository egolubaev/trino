...
public class TestCteMaterializationConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(CteMaterializationConfig.class)
                ...
                .setMaxOutputRows(5_000_000)
                .setMaxMaterializedCtes(8)
                .setMaxConcurrentMaterializations(4)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("cte-materialization.max-output-rows", "250000")
                .put("cte-materialization.max-materialized-ctes", "16")
                .put("cte-materialization.max-concurrent-materializations", "2")
        ...
        CteMaterializationConfig expected = new CteMaterializationConfig()
                ...
                .setMaxOutputRows(250_000)
                .setMaxMaterializedCtes(16)
                .setMaxConcurrentMaterializations(2)
